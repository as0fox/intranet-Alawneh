...
<div class="bg-white rounded shadow p-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('admin.events.create') }}" class="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse($events as $event)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">{{ $event->date->format('M d, Y') }}</td>
