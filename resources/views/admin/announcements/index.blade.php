...
<div class="bg-white rounded shadow p-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('admin.announcements.create') }}" class="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse($announcements as $announcement)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">{{ $announcement->button_text }}</td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <a href="{{ route('admin.announcements.edit', $announcement) }}" class="text-blue-600 hover:text-blue-900 mr-3">Edit</a>
