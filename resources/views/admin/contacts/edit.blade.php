...
<div class="bg-white rounded shadow p-6">
    <h2 class="text-xl font-semibold mb-6">Edit Contact</h2>
    ...
    <form method="POST" action="{{ route('admin.contacts.update', $contact) }}" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 gap-6">
            ...
            <div>
                <label for="photo" class="block text-sm font-medium text-gray-700 mb-1">Photo (Leave empty to keep current photo)</label>
                @if($contact->photo)
                    <div class="mb-2">
                        <img src="{{ ('/' . $contact->photo) }}" alt="Current Photo" class="h-20 rounded-full">
                    </div>
                @endif
